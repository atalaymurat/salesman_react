...
const PrivacyPolicy = () => {
  return (
    <div className="container">
      ...
      <p>
        Belirli bir kişiye ait kullanılacak ve işlenecek bilgiler, yalnızca bu
        kişinin kendi istemiyle veri girmesi ya da bu hususta açıkça muvafakat
        vermesi halinde mümkündür. Veri girilmesi veya bu hususta açıkça
        muvafakat verilmesi, kişinin aşağıda belirtilen şartlar ile mutabık
        olduğunun göstergesidir.
      </p>
      <p>
        Sitemizi ziyaret ettiğinizde, sistem yönetimi, istatistik ve “back up”
        uygulamalarının gerektirdiği bazı bilgiler sunucularımızda otomatik
        olarak depolanacaktır. Bu verilerin arasında Internet servis
        sağlayıcınızın ismi, bazı durumlarda IP adresiniz, web gezgini
        yazılımınızın versiyonu, erişim sağlanan bilgisayarın işletim sistemi,
        bize yönlendiren websitesi, sitemizdeyken ziyaret ettiğiniz diğer
        siteler ve sitemizi bulmak için kullandığınız arama sözcükleri
      ...
      <p>
        ...
        yayımlanacaktır. Bu çerçevede, size ait hangi bilgilerin saklandığına ve
      ...
      <p>
        Sosyal ağlar facebook.com ve Twitter eklentileri (“eklentiler”) web
        sayfalarımıza gömülebilir. İlgili servisler Facebook Inc. ve Twitter
        Inc. (“servis sağlayıcılar”) şirketleri tarafından sağlanır.
      </p>
      <p>
      ...
      <p>
        Web sitelerimizi ziyaret ettiğinizde verilerinizin korunma seviyesini
        artırmak için bu eklentiler “Çift tıklanan butonlar” olarak uygulamaya
        konmuştur. Bu tarz bir entegrasyon bu tarz eklentiler içeren web
        sitelerine, web sitemiz içerisinden eriştiğinizde, otomatik olarak
      ...
      <p>
        Eklenti servis sağlayıcıya hangi websitesi sayfalarımızı ziyaret
        ettiğiniz söyler. Websitemizi gezerken Facebook ya da Twitter kullanıcı
        hesabınıza bağlı olmanız durumunda, servis sağlayıcı kullanıcı
        hesabınızla eriştiğiniz bilgiler gibi ilgi duyduğunuz alanlar hakkında
        veri toplayabilir. Herhangi eklenti fonksiyonunu kullanırken (örneğin
        “Like” [Beğeni] butonuna tıklandığında, yorum yazıldığında) bu bilgi de
        tarayıcı tarafından doğrudan saklanmak üzere servis sağlayıcıya
        aktarılır.
      </p>
      <p>
      ...
      <p>
        Facebook ya da Twitter'ın, sitelerinde sahip olduğunuz kullanıcı
        hesabınızla web sitemize ziyaretinize ilişkin bağlantı kurmasını
        engellemek için, web sayfalarımıza erişmeden önce ilgili kullanıcı
        hesaplarında oturumunuzu kapatmanız gerekir.
      </p>
    </div>
  )
}
